...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("WinperfilDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["winperfilapp.com"];
pub const RS_PUB_KEY: &str = "jK2VYlZcFlZO4sTTUhkDCKnCc7l8xMfYPvAmZg2Vgqo=";
